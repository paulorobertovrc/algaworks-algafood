...
insert into estado (id, nome) values (3, 'CE');
...
insert into usuario (id, nome, email, senha, data_cadastro) values
                                                                ...
                                                                (6, 'Paulo Roberto', 'paulor.vrcavalcanti@gmail.com', '123', utc_timestamp);

insert into usuario_grupo (usuario_id, grupo_id) values (1, 1), (1, 2), (2, 2);

insert into usuario (id, nome, email, senha, data_cadastro) VALUES (5, 'Manoel Lima', 'manoel.loja@loja.com', '123', utc_timestamp);
...
values (1, '1584551a-65c2-4667-b77d-7ecab2b9cfb1', 1, 6, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                    status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, '4723989d-f374-4f44-a7e6-e0cc32f9c7b7' , 4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
