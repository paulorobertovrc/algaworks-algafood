...
import br.dev.pauloroberto.algafood.api.v1.openapi.controller.UsuarioGrupoControllerOpenApi;
...
public class UsuarioGrupoController implements UsuarioGrupoControllerOpenApi {
    ...
    public CollectionModel<GrupoDto> listar(@PathVariable Long usuarioId) {
        ...
        gruposModel.getContent().forEach(grupoModel -> grupoModel.add(linkHelper.linkToUsuarioGrupoDesassociacao(
